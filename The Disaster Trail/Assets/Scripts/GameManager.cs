...
public class GameManager : MonoBehaviour
{
	...
	//Tracks route taken by car in Overworld
	...
	void Update()
	{
		...
		if (fadeIn)
		{
            transitionImage.color = new Color(transitionImage.color.r, transitionImage.color.g, transitionImage.color.b, Mathf.Max(0, transitionImage.color.a - fadeAmount));
		...
		if (fadeOut)
		{
			transitionImage.color = new Color(transitionImage.color.r, transitionImage.color.g, transitionImage.color.b, Mathf.Min(1, transitionImage.color.a + fadeAmount));
	...
	public void SetTrail(Vector3[] trail){this.trail = trail;}
